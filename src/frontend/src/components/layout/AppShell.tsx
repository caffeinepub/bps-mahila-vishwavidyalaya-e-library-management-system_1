        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img src="/assets/generated/app-icon-book.dim_256x256.png" alt="Library" className="w-10 h-10" />
              <div>
                <h1 className="text-xl font-bold text-foreground">BPS E-Library</h1>
                <p className="text-xs text-muted-foreground">Mahila Vishwavidyalaya, Khanpur Kalan</p>
              </div>
            </div>
